    ...
    $("#curs").click(function(){
        ...
        str += 'Từ lúc mình gặp nhau đến giờ đó là\n'; 
        str += 'khoảng thời gian vui vẻ nhất của Anh, có những\n';  
        str += 'khoảng thời gian đi chơi, đi xem phim, đi ăn \n'; 
        str += 'với nhau , Anh vui lắm. Cảm ơn Em đã \n';  
        str += 'cho Anh những khoảnh khắc \n';  
        str += 'vui vẻ như vậy.\n';    
        str += 'Anh Yêu \n';
        str += 'Em.';
        Printer.init(str, {
    ...
    function SetTime(){
        ...
        var date1=new Date("Tus May 31 2021"); 
        var date2=new Date(); 
        console.log(date2);
